...
import { editPost, fetchPost, postData, queryClient } from "../util/http";
...
const EditPostForm: React.FC = () => {
    ...
    const handleEditPost = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        let postData = Object.fromEntries(fd.entries()) as Record<string, FormDataEntryValue>;
        ...
        postData = { ...postData, date: new Date().toISOString() }

        const typedPostData: postData = {
        ...
        mutate({ postId: params.postId ?? "", postData: typedPostData });
    }
